		...
		<div id="lat_derecho">
			...
			<c:choose>
			    ...
			    <c:otherwise>
					...
					<form:form action="${pageContext.request.contextPath}/gasto/cobrarGastoColectivo/${idPago}" method="POST">
						<ul>
			...
			${mensajeConfirmacion}
			<p><a href="${pageContext.request.contextPath}/gasto/verPagos"><img src="<c:url value="/resources/img/planing.png"/>" /> Volver al desglose de pagos</a></p>
		</div>
	</div>
</body>
</html>