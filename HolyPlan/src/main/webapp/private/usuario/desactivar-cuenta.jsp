...
<body>
	...
	<div id="cuerpo">
		...
		<div id="lat_derecho">
			<h1>Desactivar cuenta de usuario</h1>
			<p>Si desactivas tu cuenta no podrás volver a acceder a tus datos</p>
			<p>¿Seguro que quieres desactivarla?</p>
			<a href="${pageContext.request.contextPath}/usuario/confDesactivarCuenta?uid=${hash}"><img src="<c:url value="/resources/img/borrar.png"/>" /> Desactivar</a>
		</div>
	</div>
</body>
</html>