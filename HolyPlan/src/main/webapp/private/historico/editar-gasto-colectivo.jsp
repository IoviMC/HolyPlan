...
<head>
	...
	<title>HolyPlan - Editar Gasto Colectivo</title>
...
<body>
	...
	<div id="cuerpo">
		...
		<div id="lat_derecho">
			<h1><img src="<c:url value="/resources/img/datos.png"/>" /> Editar gasto colectivo</h1>
			<H2>Datos</H2>
			<form:form method="POST" modelAttribute="editarGastoForm" action="${pageContext.request.contextPath}/historico/modificarGastoColectivo">
				<table>
					<tr>
